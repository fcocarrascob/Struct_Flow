...
export { compararPatrones, avisosPesoPropio, patronesDeFlow, traerDeSap, adoptarDeSap, planEmpuje, aplicacionesDeObra, compararAplicacion, hermanasDe, planAplicaciones } from './sap';
